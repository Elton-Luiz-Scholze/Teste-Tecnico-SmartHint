...
namespace Teste_Tecnico_SmartHint.Controllers
{
    public class CustomersController : Controller
    {
        private readonly Contexto _context;

        public CustomersController(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Telephone,Created_at,Type,CPF_CNPJ,StateRegistration,Is_free,Gender,Birthdate,Is_blocked,Password, PasswordConfirm")] Customers customers)
        {
